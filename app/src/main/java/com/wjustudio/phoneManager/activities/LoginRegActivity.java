                    ...
                    new AsyncTask<String, Void, String>() {
                        ...
                        protected void onPostExecute(String result) {
                            ...
                            if ("-1".equals(result)) {
                                ...
                                enterMainActivity();
                                SpUtil.putString(AppConstants.LOGIN_USER,email);
        ...
        confirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(emailStr)) {
                    toast("邮箱不能为空");
                } else if (!(CommonUtil.isCorrectEmail(emailStr))) {
                    toast("邮箱格式不正确");
                } else {
    ...
    private void initLoginDialog(AlertDialog.Builder builder) {
        ...
        forget_pwd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (CommonUtil.isCorrectEmail(userStr)){
        ...
        confirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(userStr)) {
                    toast("用户不能为空");
                } else if (!(CommonUtil.isCorrectEmail(userStr) || CommonUtil.isCorrectName(userStr))) {
                    toast("用户格式不正确");
                    ...
                    new AsyncTask<String, Void, String>() {
                        ...
                        protected void onPostExecute(String result) {
                            ...
                            if ("2".equals(result)) {
                                mLoginDialog.dismiss();
                                toast("登录成功");
                                SpUtil.putString(AppConstants.LOGIN_USER,userStr);
                               enterMainActivity();
                            } else if ("1".equals(result)) {
                                //验证失败
                                toast("用户不存在");
